...
- **Geometric means** aren't affected by a few highly expressed genes
- **Median ratios** are resistant to outliers
- **Gene-specific ratios** account for natural expression differences
...
sizeFactors(dds)
```
**Best for**: Differential expression analysis
**Pros**: Robust, handles composition bias well
**Cons**: Doesn't account for gene length
...
```
**Best for**: Alternative to DESeq2, especially with extreme composition bias
...
```
**Best for**: Comparing expression between different genes
**Pros**: Accounts for gene length
**Cons**: Not recommended for differential expression
